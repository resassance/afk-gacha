...
const I18N = {
    ru: {
        ...
        stat_gold: "Монеты", stat_bm: "Общая БМ Отряда", stat_tokens: "Жетоны", stat_unique: "Собрано Тян",
        btn_wiki: "📖 Справочник", btn_fullscreen: "⛶ Полный экран", btn_settings: "⚙️ Настройки",
        squad_title: "⚔️ Тактический статус отряда",
        lbl_win_streak: "Побед подряд:", lbl_max_streak: "Рекорд серии:",
        ...
        mythic_buy_atk: "🌌 Меч Бездны (1,000,000 монет)", mythic_buy_hp: "👑 Щит Этернала (1,000,000 монет)", mythic_buy_gold: "💎 Рог Изобилия (1,000,000 монет)",
        mythic_squad: "Мифический отряд",
        banner_title: "Молитва Прекрасных Воительниц",
        banner_subtitle: "1 призыв = 100 Кредитов. Соберите сильнейший отряд для покорения подземелий.",
        ...
        inv_title: "Ваш Боевой Отряд", inv_subtitle: "Прямой выкуп дубликатов доступен за Жетоны!",
        ...
        overflow_manage: "Освободите место:",
        ...
        battle_info: "Атака отряда: {atk} АТК/сек | Сила монстра: {matk} АТК/сек | +{gold} монеты/с",
        ...
        toast_reforge_evo: "✨ Успешная эволюция! Получена редкость {tier}!",
        toast_reforge_done: "🔨 Перековка завершена. Получена редкость {tier}",
        toast_reforge_evo2: "✨ Великолепный исход! Реликвия эволюционировала в {tier}!",
        toast_reforge_done2: "🔨 Перековка завершена. Получен предмет редкости {tier}",
        toast_reforge_bulk: "🔨 Массовая перековка {tier}: {n}x, эволюций в след. редкость: {evo}",
        ...
        toast_mythic_all_collected: "✨ Все мифические богини собраны! Выдано утешение: +500,000 монет!",
        ...
        toast_not_enough_gold_shop: "Недостаточно монет! Лавка требует 1,000,000 монет.",
        ...
        confirm_reset1: "Вы уверены? Это НАВСЕГДА удалит весь прогресс: героинь, снаряжение, монеты, жетоны и этаж. Отменить будет нельзя.",
        ...
        wiki_base_stats: "Базовые (1 копия): АТК {atk} | ХП {hp} | ЗОЛ +{gold}/с",
        wiki_base_stats_m: "Базовые: АТК {atk} | ХП {hp} | ЗОЛ +{gold}/с",
    ...
    en: {
        ...
        stat_gold: "Coins", stat_bm: "Total Squad CP", stat_tokens: "Tokens", stat_unique: "Heroines Collected",
        btn_wiki: "📖 Codex", btn_fullscreen: "⛶ Fullscreen", btn_settings: "⚙️ Settings",
        squad_title: "⚔️ Squad Tactical Status",
        lbl_win_streak: "Wins in a row:", lbl_max_streak: "Best streak:",
        ...
        mythic_buy_atk: "🌌 Blade of the Abyss (1,000,000 coins)", mythic_buy_hp: "👑 Aegis of the Eternal (1,000,000 coins)", mythic_buy_gold: "💎 Horn of Plenty (1,000,000 coins)",
        mythic_squad: "Mythic Squad",
        banner_title: "Prayer of the Beautiful Warriors",
        banner_subtitle: "1 summon = 100 Credits. Gather the strongest squad to conquer the dungeons.",
        ...
        battle_info: "Squad attack: {atk} ATK/sec | Monster power: {matk} ATK/sec | +{gold} coins/s",
        ...
        toast_gear_sold: "💰 Relic sold for +{price} coins!",
        toast_gear_looted: "⚔️ Trophy dropped: {name} (+{bonus} {label})!",
        toast_gear_added_inv: "⚔️ Item added to armory (+{bonus} {label})!",
        toast_gear_sold_immediate: "💰 New trophy sold instantly for +{price} coins!",
        toast_old_gear_sold: "💰 Old relic sold for +{price} coins!",
        ...
        toast_mythic_all_collected: "✨ All mythic goddesses collected! Consolation reward: +500,000 coins!",
        ...
        toast_not_enough_gold_shop: "Not enough credits! The shop requires 1,000,000 coins.",
        ...
        confirm_reset1: "Are you sure? This will PERMANENTLY delete all progress: heroines, gear, coins, tokens and floor. This cannot be undone.",
        ...
        wiki_base_stats: "Base (1 copy): ATK {atk} | HP {hp} | COINS +{gold}/s",
        wiki_base_stats_m: "Base: ATK {atk} | HP {hp} | COINS +{gold}/s",
